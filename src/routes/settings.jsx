        ...
        <div className="grid gap-6 lg:grid-cols-[200px_1fr]">
          ...
          <div className="space-y-4">
            {tab === "General" && (<>
                <form onSubmit={handleSaveGeneral}>
                    <Panel title="Workspace" actions={
                        <button type="submit" className="h-7 rounded bg-[#5F6AD2] px-3 text-[11px] font-medium text-white hover:bg-[#4F5ABF] transition-all cursor-pointer">Save</button>
                    }>
            ...
            {tab === "Account" && (<Panel title="Profile" actions={
                <button onClick={() => showToast("User profile saved.")} className="h-7 rounded bg-[#5F6AD2] px-3 text-[11px] font-medium text-white hover:bg-[#4F5ABF] transition-all cursor-pointer">Save</button>
            }>
                <div className="space-y-4 max-w-md">
                    <div>
                        <label className="text-[11.5px] text-muted-foreground block">Name</label>
